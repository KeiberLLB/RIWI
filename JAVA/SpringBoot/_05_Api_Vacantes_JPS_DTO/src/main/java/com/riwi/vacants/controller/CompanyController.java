...
import com.riwi.vacants.entities.utils.dto.errors.ErrorResponse;
import com.riwi.vacants.entities.utils.dto.errors.ErrorsResponse;
...
public class CompanyController {
  ...
  @PostMapping
  public ResponseEntity<CompanyResponse> insert(@Validated @RequestBody CompanyRequest entity) {
  ...
  public ResponseEntity<CompanyResponse> update(
      @Validated @RequestBody CompanyRequest company, @PathVariable String id) {
